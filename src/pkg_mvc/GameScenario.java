...
public class GameScenario
{
    ...
    public void initGameScenario()
    {
        ...
        NPCharacter chef_enquete = new NPCharacter("Chef d'Enquete","chefenquete","Qu'est ce que vous faites lÃ  ?!?! \nSortez de mon bureau !",Event.NO_EVENT);
        NPCharacter enfant = new NPCharacter("Petit Enfant","enfant","Bonjour monsieur... (baisse la tete)",Event.NO_EVENT);
        NPCharacter jack_ginger = new NPCharacter("Enqueteur","enqueteur","Hahaha tu es tombé dans mon piÃ¨ge ! tu va mourir !",Event.GAME_OVER);
        ...
        chapeau = new Item(20,"Un chapeau melon gris oÃ¹ la lettre 'J' était brodée","chapeau",Event.NO_EVENT,Event.HAVE_SEEN_HAT,"Ramassé : Chapeau","Un chapeau etrange... Avec un 'J' brodé dessus...");
