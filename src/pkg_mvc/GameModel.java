...
public class GameModel extends Observable
{
    ...
    {
        //CrÃ©e les diffÃ©rents objets non essentiels du jeu
        ...
        carte = new Item(10,"Une carte de Londres","carte",Event.NO_EVENT,Event.NO_EVENT,"RamassÃ© : Carte de Londres","Une carte de Londres trés detaillée");
        ...
        beamer = new Beamer(5,"Beamer qui permet, après avoir été chargé \n de se téléporter dans la salle sauvegardée","beamer");
        cle_transport = new Item(0, "Une petite clé jolie avec ecrit dessus : \n\tClé de la salle de transport","cletransport",Event.NO_EVENT,Event.NO_EVENT,"Ramassé : La clé de la salle de transport","Une clé ne s'utilise pas comme ca...");
        //Place les diffÃ©rents objets dans les diffÃ©rentes piÃ¨ces (initialisation)
    ...
    private void createRooms()
    {
        ...
        bureau = new Room("Bureau d'enquete de Londres","dans le bureau d'enquÃªte","Bureau",4,false);
        ...
        //CrÃ©ation d'une hashmap des rooms
        ...
        //Initialise la piÃ¨ce courante : on dÃ©marre le jeu Ã  la gare
        currentRoom = gare;
        
        //CrÃ©e un pile(mÃ©moire) afin de stocker les diffÃ©rentes piÃ¨ces parcourues par le joueur. Elle est utlisÃ© par la commance back pour que le joueur retrouve son chemin
    ...
    {
        return "Bienvenue dans Who is Jack !\n\nVous vous retrouvez projeté dans le XIXème siècle, dans la peau d'un enqueteur de renom\n" +
